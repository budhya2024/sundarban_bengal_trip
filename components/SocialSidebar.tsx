    ...
    <div className="fixed right-1 md:right-2 top-1/2 -translate-y-1/2 z-40 scale-75 md:scale-100 flex flex-col gap-2">
      {socialLinks.map((social) => (
        <a
          ...
          className={`w-12 h-12 flex items-center justify-center text-primary-foreground transition-all rounded-full shadow-md scale-90 hover:scale-100 duration-300 ${social.bgColor}`}
        >
