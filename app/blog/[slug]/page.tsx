...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt:
      "Learn about the magnificent tigers of Sundarbans and their unique adaptations.",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "Expert tips for capturing stunning wildlife photos in challenging mangrove conditions.",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "Why sunset cruises are the most romantic way to experience the Sundarbans.",
    content: `
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <BlogSidebar latestPosts={blogPosts} currentPostId={post.id} />
            </div>
          </div>
        </div>
      </section>
