...
const packages = [
  {
    ...
    reviews: 124,
    description:
      "Perfect for first-time visitors, this day trip covers the essential Sundarban experience with boat safari and wildlife spotting.",
    features: [
      "Guided boat safari",
      "Wildlife spotting",
  ...
  },
  {
    ...
    reviews: 89,
    description:
      "An immersive experience with overnight camping, multiple safaris, and cultural encounters with local villages.",
    features: [
      "Camping experience",
  ...
  },
  {
    ...
    popular: true,
    description:
      "Our flagship experience featuring luxury houseboat accommodation, tiger territory exploration, and exclusive access to restricted areas.",
    features: [
  ...
  },
  {
    ...
    reviews: 42,
    description:
      "Designed for serious photographers, this expedition focuses on wildlife photography with expert guidance and optimal timing.",
    features: [
